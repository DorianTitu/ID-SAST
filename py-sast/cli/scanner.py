...
class CLI:
    """
    Command Line Interface para PY-SAST.
    """
    ...
    def run(self) -> None:
        ...
        parser = argparse.ArgumentParser(
            prog="py-sast",
            description="PY-SAST — Python Static Application Security Testing",
        )
        ...
        try:
            ...
            print("\n[PY-SAST] Scan interrupted by user.")
            sys.exit(0)
    ...
    def _scan_command(self, args) -> None:
        ...
        print(f"\n[PY-SAST] Scanning: {project_path}")
        print(f"[PY-SAST] Python files found: {len(py_files)}")
